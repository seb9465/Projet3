...
//        self.currentTool = ClassFigure();
//        self.currentTool.setInitialPoint(initialPoint: firstPoint);
//        self.currentTool.setLastPoint(lastPoint: secondPoint);
//
//        self.selectFigureService = SelectFigureService();
//
//        super.init(frame: CGRect(x: firstPoint.x, y: firstPoint.y, width: 103, height: 103));
//
//        self.selectFigureService.setInitialSelectedDashedBorder(bounds: self.bounds);
////        self.selectFigureService.setInitialSelectedCornerCirles(firstPoint: fPoint, lastPoint: lPoint);
//
