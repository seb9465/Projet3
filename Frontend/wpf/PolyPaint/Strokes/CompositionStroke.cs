...
{
    public class CompositionStroke : Stroke, ICanvasable
    {
        public InkCanvas SurfaceDessin { get; set; }
        public CompositionStroke(StylusPointCollection pts, InkCanvas surfaceDessin)
            : base(pts)
        {
            StylusPoints = pts;
        ...
        protected override void DrawCore(DrawingContext drawingContext, DrawingAttributes drawingAttributes)
        {
            ...
            drawingContext.DrawLine(pen, new Point(stp.X, stp.Y), new Point(sp.X - 20, sp.Y));

            Point point2 = new Point(sp.X - 10, sp.Y - 10);
            Point point3 = new Point(sp.X - 20, sp.Y);
            Point point4 = new Point(sp.X - 10, sp.Y + 10);
            Point point5 = new Point(sp.X, sp.Y);
